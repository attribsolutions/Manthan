...
import RoleAccessData2 from "./RoleAccessDemoData2";
...
function* RoleAccessListPage_GenratorFunction() {
  debugger
 
  try {
    // const response = yield call("");
      yield put(GetRoleAccessListPageSuccess(RoleAccessData2));
    }
  catch (error) {
  }
}
console.log("RoleAccessData2",RoleAccessData2)
...
function* RoleAccessSaga() {
  ...
  yield takeEvery(GET_ROLEACCESS_LIST_PAGE, RoleAccessListPage_GenratorFunction);

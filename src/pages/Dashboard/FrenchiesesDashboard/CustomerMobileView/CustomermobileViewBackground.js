...
export const CustomermobileViewBackground = (props) => {
    ...
    const handleClick = (num) => {
        ...
        const value = CustomerMobileNumber + num;
        const isNumber = /^\d{0,10}$/.test(value)
    ...
    const handleBackspace = () => {
        const value = CustomerMobileNumber.slice(0, -1);
        const isNumber = /^\d{0,10}$/.test(value)
        if (isNumber) {
            setCustomerMobileNumber(value);
            // Validate the mobile number
        ...
        <React.Fragment>
            ...
            >
                ...
                <div style={{ zIndex: 2, textAlign: 'center', }}>
                    ...
                    <Card className="mt-4" style={{ borderRadius: "30px", padding: "15px" }}>
                        <NumberPad
                        ...
                        />
                        <button id="BTN_ID" ref={buttonRef} className="button" onClick={SaveHandler} style={{ marginTop: "30px" }}>
...
export const NumberPad = ({ handleClick, handleBackspace }) => {
    ...
    return (
        <div style={{ marginLeft: "42px", fontSize: "23px" }}>
            <ul id="keyboard" onContextMenu={disableContextMenu}>
                ...
                <li className="letter clearl"
                    onClick={handleBackspace}>{`<`}</li> {/* Back button */}
                <li className="letter" onClick={() => handleClick('0')}>0</li>
                <li className="letter" onClick={() => handleClick('Clear')}>Clear</li>

...
//     // Call initializeTableData function on component load
//     useEffect(() => {
...
//             const hasRestrictedUnits = TableData.some(row => ["No", "Kg", "Box"].includes(row.Unit.label));
...
//                                 </Row>
//                             ) : (
//                                 !index.IsBase && hasRestrictedUnits && (
//                                     <i
//                                         className="mdi mdi-trash-can d-block text-danger font-size-20"
//                                         onClick={() => deleteRow_Handler(index.id)}
//                                     >

...
import { CheckStockEntryForFirstTransaction, GetStockCount, Get_Items_Drop_Down, Get_Items_Drop_Down_Success, saveStockEntryAction, saveStockEntrySuccess } from "../../../store/Inventory/StockEntryRedux/action";
            ...
            formatter: (cellContent, row, key) => {
                ...
                return (<span style={{ justifyContent: 'center' }}>
                    <CInput
                        ...
                        className="text-end"
                        onChange={(e) => {
                            row.Qty = e.target.value === "" ? undefined : e.target.value;
                        }}
                    />
                </span>)
            }
                                ...
                                <Col sm={4} className="">
                                    <FormGroup className="mb- row mt-3 mb-1 ms-2 " >
                                        ...
                                        <Col sm="7" >
                                            <C_DatePicker
                                                name='Date'
                                                disabled={!StockEnteryForFirstYear.Data}
                                                value={values.Date}

...
function* postGRNGenFunc({ data }) {                      //  Save GRN Grnrator function 
  try {
...
function* Edit_GRN_GenratorFunction({ id, pageMode }) {   //  Edit GRN Grnrator function 
  try {
...
function* DeleteGRNGenFunc({ id }) {                      //  Delete GRN Grnrator function 
  try {
...
function* UpdateGRNGenFunc({ data, id }) {                //  Upadte GRN Grnrator function 
  try {
...
function* get_GRN_GerFunc({ filters }) {                 //   GRN List filter Grnrator function 
  try {
...
function* getGRNitem_Mode2_GenFunc({ data }) {           //   Make_GRN Items Grnrator function
